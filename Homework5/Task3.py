...
languages = list(map(lambda language: language.upper(), ['python', 'c#', 'java',
                                                         'c++', 'java_script', 'php', 'fortaran']))
print(languages)
numbers = [x for x in range(1, len(languages)+1)]


numbers_languages = list(zip(numbers,languages))
print(numbers_languages)
...
print((swaped_numbers_languages(numbers_languages)))   
